...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个热爱人工智能的基层干部', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.tonyaisz.cn/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'AI, 人工智能', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'tolbl@foxmail.com', // 邮箱地址 例如mail@tangly1024.com
